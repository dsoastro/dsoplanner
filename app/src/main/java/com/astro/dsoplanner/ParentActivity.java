...
public class ParentActivity extends Activity {
	...
	protected FloatingActionButton fabButtonBack;
	...
	protected void onResume(){
		...
		if(nightMode && showButtonsInRedMode){
			...
			if(fabButtonMenu==null){
				fabButtonMenu = SettingsActivity.getDayModeMenuButton(this,height,color);
	...
	BroadcastReceiver messageReceiver=new BroadcastReceiver(){	
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(Constants.IDIS_ERROR_BROADCAST.equals(action)){
				...
				if(s!=null){
					InputDialog.toast(s,ParentActivity.this).show();
	...
	private void registerBatteryMonitor() {
		mBatteryReceiver = new BroadcastReceiver() {
	        ...
	        public void onReceive(Context context, Intent intent) {
	            ...
	            //Dlog.e("BatteryManager", "level is "+level+"/"+scale+", temp is "+temp+", voltage is "+voltage);
	        }
	    };
