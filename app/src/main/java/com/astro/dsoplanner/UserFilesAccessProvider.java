...
public class UserFilesAccessProvider extends DocumentsProvider {
    private static final String TAG = "UserFilesAccessProvider";
    ...
    public boolean onCreate() {
        Init.initRootDirs(this.getContext());
        mBaseDir = new File(Global.exportImportPath);
        return true;
    }
    ...
    public Cursor queryRoots(String[] projection) throws FileNotFoundException {
        ...
        row.add(Root.COLUMN_SUMMARY, "User Data");
                ...
                return ParcelFileDescriptor.open(file, accessMode, handler,
                    new ParcelFileDescriptor.OnCloseListener() {
                        ...
                        public void onClose(IOException e) {
                            // Update the file with the server.  The client is done writing.
