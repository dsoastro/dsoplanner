...
/**
 * former ColorPickerView
 * @author leonid
 *
 */
public class CoPV extends View{
	 ...
	 */
	private float 		HUE_PANEL_WIDTH = 40f;	
	/**
	 ...
	 */
	private float		RECTANGLE_TRACKER_OFFSET = 20f;
	...
	public CoPV(Context context){
		this(context, null);
	}
	
	public CoPV(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}
	
	public CoPV(Context context, AttributeSet attrs, int defStyle) {
	...
	private void drawHuePanel(Canvas canvas){
		...
		mSatValTrackerPaint.setColor(0xff000000);
		canvas.drawCircle(p.x+RECTANGLE_TRACKER_OFFSET, p.y, PALETTE_CIRCLE_TRACKER_RADIUS - 1f * mDensity, mSatValTrackerPaint);
				
		mSatValTrackerPaint.setColor(0xffdddddd);
		canvas.drawCircle(p.x+RECTANGLE_TRACKER_OFFSET, p.y, PALETTE_CIRCLE_TRACKER_RADIUS, mSatValTrackerPaint);
	...
	private void drawAlphaPanel(Canvas canvas){
		...
		mSatValTrackerPaint.setColor(0xff000000);
		canvas.drawCircle(p.x, p.y+RECTANGLE_TRACKER_OFFSET, PALETTE_CIRCLE_TRACKER_RADIUS - 1f * mDensity, mSatValTrackerPaint);
				
		mSatValTrackerPaint.setColor(0xffdddddd);
		canvas.drawCircle(p.x, p.y+RECTANGLE_TRACKER_OFFSET, PALETTE_CIRCLE_TRACKER_RADIUS, mSatValTrackerPaint);
